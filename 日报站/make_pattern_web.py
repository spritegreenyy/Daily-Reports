...
const PATTERN_EN={"对称三角":"Symmetrical Triangle","下降三角":"Descending Triangle","上升三角":"Ascending Triangle","空头三角旗":"Bearish Pennant","多头三角旗":"Bull Flag","矩形":"Rectangle","上升楔形":"Rising Wedge","下降楔形":"Falling Wedge","楔形":"Wedge","旗形":"Flag","多头旗形":"Bull Flag","空头旗形":"Bear Flag"};
...
function stateLabel(v){if(lang==='zh')return v;return (v||"").replace("形成中·待突破","Forming · waiting for breakout").replace("形成中·待破位","Forming · waiting for breakdown").replace("已破颈线·目标未到(可跟)","Neckline broken · target pending").replace("已突破·目标未到(可跟)","Breakout confirmed · target pending").replace("目标已到位·形态基本兑现","Target reached · pattern largely played out").replace("目标已位·形态基本兑现","Target reached · pattern largely played out").replace("已兑现","Played out")}
